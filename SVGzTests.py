...
class MyFirsttests(unittest.TestCase):
    ...
    def test_init_ellipse(self):
        self.assertEqual(SVGzEllipse(0,0,0,0).svgTxt,f'<ellipse cx="0" cy="0" rx="0" ry="0" stroke="green"></ellipse>\n')

    def test_line_svg_update(self):
        line = SVGzEllipse(0,0,0,0)
        line.cx = 4
        line.stroke = "green"
        self.assertEqual(line.getSVGTxt(),f'<ellipse cx="4" cy="0" rx="0" ry="0" stroke="green"></ellipse>\n')
